...
const vanessa = {
  ...
  location:   "Portugal 🇵🇹",
  focus:      ["LLM Integration", "Intelligent UIs", "Scalable Web Apps"],
  currentlyLearning: ["LangChain", "RAG Pipelines", "Vector Databases"],
